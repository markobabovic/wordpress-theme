...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
						...
						<span class="product-remove">
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove-item" aria-label="%s" data-product_id="%s" data-product_sku="%s">Remove</a>',
	...
	<div class="wrap-total">
		<p><?= __("Shipping costs will be calculated at checkout", "moneymouth") ?></p>
		<div class="inner">
			<div class="total-label">
				<span>Total</span>
			</div>
			<div class="total-value">
				<?php $totalAmount = WC()->cart->total;; ?>
	...
	<div class="wrap-coupon">
		<?php if ( wc_coupons_enabled() ) { ?>
			<div class="coupon">
				<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Enter Promotional Code', 'woocommerce' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Submit', 'woocommerce' ); ?></button>
